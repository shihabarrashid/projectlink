...
<head>
    ...
    <title>StudBud|Admin Dashboard</title>
    <!-- CSS only -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="card border-white" style="width: 18rem;">
            ...
            <div class="card-body">
              <br>
              <a href="admin_reg.php" class="btn btn-primary position-absolute start-50 translate-middle">Admin</a>
            </div>
          </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card border-white" style="width: 18rem;">
            <img src="images/moderator.png" class="card-img-top" alt="...">
            <div class="card-body">
              <br>
              <a href="moderator_reg.php" class="btn btn-primary position-absolute start-50 translate-middle">Moderator</a>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="card border-white" style="width: 18rem;">
            <img src="images/instructor.png" class="card-img-top" alt="...">
            <div class="card-body">
              <br>
              <a href="ins_reg.php" class="btn btn-primary position-absolute start-50 translate-middle">Instructor</a>
            </div>
          </div>
          </div>
          ...
          <div class="col-md-3">
            ...
            <div class="card-body">
              <br>
              <a href="user_reg.php" class="btn btn-primary position-absolute start-50 translate-middle">Student</a>
            </div>
          </div>
          </div>
        </div>
