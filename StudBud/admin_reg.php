...
<head>
    ...
    <title>StudBud|Admin Registration</title>
    ...
    <main>
        <div class="register-col">
            <section class="register">
                ...
                <form name="myform" action="admin_reg_process.php" method="post" onsubmit="return validateform()">
                    <p>Name</p>
                    <input type="text" name="name" id="name" onblur="checkUName()" onkeyup="checkNameKeyUp()" placeholder="Enter Admin Name">
                    <small class="text-danger" id="nameErr"></small>

                    <p>Email</p>
                    <input type="text" class="form-control" name = "email" id="email" onblur="checkEmail()" placeholder="Enter Admin Email">
                    <small class="text-danger" id="emailErr"></small>

                    <p>Username</p>
                    <input type="text" name="uname" id="uname" onblur="checkUName()" placeholder="Enter Admin Username">
                    <small class="text-danger" id="uNameErr"></small>

                    <p>Password</p>
                    <input type="password" name="pass" id="pass" onblur="checkPass()" placeholder="Enter Admin Password">
                    <small class="text-danger" id="passErr"></small>

                    <p>Institution</p>
                    <input type="text" name="ins" id="ins" onblur="checkIns()" placeholder="Enter Admin Institution">
